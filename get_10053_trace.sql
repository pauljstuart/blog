...
-- Author : Paul Stuart
-- Date   : Sept 2014
-- Desc   :  This script creates a 10053 optimizer trace file for a given SQL_ID and automatically
--           displays it in SQL developer and spools it to a local file.
-- Usage :  @get_10053_trace <sql_id> <child_num>
--
----------------------------------------------------------------------------------------------------
